...
namespace Proyecto_a_Pensar
{
    public partial class Form1 : Form
    {
                ...
                if(CartasSeleccionadas.Count==2){
                    ...
                    if (Carta1 != Carta2)
                    {
                        ...
                        if (CantidadDeCartasVolteadas>7){
                            MessageBox.Show("El juego termino , Ganaste!!");
                        }
        ...
        switch (NumeroImagen) {
            case 0: TmpImg = Proyecto_a_Pensar.Properties.Resources.Img11;
                break;
            default: TmpImg = (Bitmap)Proyecto_a_Pensar.Properties.Resources.ResourceManager.GetObject("Img"+NumeroImagen);
                break;
        }
        return TmpImg;
